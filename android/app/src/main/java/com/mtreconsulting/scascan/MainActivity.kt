package com.mtreconsulting.scascan
...
import com.mtreconsulting.scascan.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    companion object {
        const val ACTION_QUICK_SCAN = "com.mtreconsulting.scascan.ACTION_QUICK_SCAN"
        const val ACTION_QUICK_BARCODE = "com.mtreconsulting.scascan.ACTION_QUICK_BARCODE"
        const val ACTION_QUICK_SEARCH = "com.mtreconsulting.scascan.ACTION_QUICK_SEARCH"
        const val ACTION_OPEN_LOG = "com.mtreconsulting.scascan.ACTION_OPEN_LOG"
        const val ACTION_SHOW_ANALYSIS = "com.mtreconsulting.scascan.ACTION_SHOW_ANALYSIS"
            ...
            try {
                ...
                when (action) {
                    ...
                    ACTION_SHOW_ANALYSIS -> {
                        ...
                        if (json != null) {
                            val facts = com.google.gson.Gson().fromJson(json, com.mtreconsulting.scascan.data.model.NutritionFacts::class.java)
